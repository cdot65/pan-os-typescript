...
export function PanosCMDK() {
  const { resolvedTheme: theme } = useTheme();
  const [value, setValue] = React.useState('scm');
  ...
  return (
    <div className="panos">
      <Command value={value} onValueChange={(v) => setValue(v)}>
        <div cmdk-panos-top-shine="" />
        <Command.Input
          ref={inputRef}
          autoFocus
          placeholder="Search for apps and commands..."
        />
        <hr cmdk-panos-loader="" />
        ...
        <div cmdk-panos-footer="">
          {theme === 'dark' ? <PanosDarkIcon /> : <PanosLightIcon />}

          <button cmdk-panos-open-trigger="">
            Open Application
            <kbd>↵</kbd>
          </button>
...
function Item({
  ...
  return (
    <Command.Item value={value} onSelect={() => {}}>
      {children}
      <span cmdk-panos-meta="">{isCommand ? 'Command' : 'Application'}</span>
    </Command.Item>
  );
}
...
function SubItem({
  ...
  return (
    <Command.Item>
      {children}
      <div cmdk-panos-submenu-shortcuts="">
