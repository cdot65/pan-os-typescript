  ...
  return (
    <div className="prisma">
      <Command value={value} onValueChange={(v) => setValue(v)}>
        ...
        <Command.List>
          <div cmdk-prisma-items="">
            <div cmdk-prisma-left="">
            ...
            <hr cmdk-prisma-separator="" />
            <div cmdk-prisma-right="">
              {value === 'button' && <Button />}
              {value === 'input' && <Input />}
              {value === 'badge' && <Badge />}
              {value === 'radio' && <Radio />}
...
function Badge() {
  return <div cmdk-prisma-badge="">Badge</div>;
}

function Radio() {
  return (
    <label cmdk-prisma-radio="">
...
function Container() {
  return <div cmdk-prisma-container="" />;
}
...
function Item({
  ...
  return (
    <Command.Item value={value} onSelect={() => {}}>
      <div cmdk-prisma-icon-wrapper="">{children}</div>
      <div cmdk-prisma-item-meta="">
        {value}
        <span cmdk-prisma-item-subtitle="">{subtitle}</span>
      </div>
    </Command.Item>
  );
}
